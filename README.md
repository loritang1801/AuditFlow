...
- Current product API covers workspace/cycle creation, artifact-backed imports with evidence chunking, review/gap decisions, narratives, workflow-backed cycle processing, and export package projection
